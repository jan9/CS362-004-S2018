/*
Team 4: (ONID: macabuha) Alan's dominion.c code
https://github.com/amac714/CS362-004-S2018/blob/macabuha-assignment-2/projects/macabuha/dominion/dominion.c
*/
#include "dominion.h"
...
int minionCard(struct gameState *state, int handPos, int choice1, int choice2)
{
  int currentPlayer = whoseTurn(state);
  int i, j;
  //+1 action
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
  {
    ...
    case minion:
      return minionCard(state, handPos, choice1, choice2);
